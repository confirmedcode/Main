...
/*  Adapted from https://github.com/mapbox/password-rules 
    Modified to include _ as a special character          */

const pwRules = function(pw, rules) {
    var issues = [];
    rules = rules || {};
    ...
    if (rules.requireSpecial && !pw.match(/[\W_]+/g)) {
        issues.push({
...
module.exports = (value) => {
  let result = pwRules(value, PASSWORD_RULES);
  if (result !== false) {
